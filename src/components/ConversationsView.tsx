...
// 25/08: היה 15000, ומדידה מול הפרודקשן הראתה שבנייה עם מטמון ריק לוקחת ~34
// שניות. כלומר הדפדפן ויתר לפני שהשרת הספיק לענות, ניסה שוב, ושוב מצא מטמון
// ריק — לולאה אינסופית של "החיבור איטי או נותק" שנגה ולייה ראו על המסך.
// התיקון האמיתי הוא חימום המטמון בצד השרת; זה כאן הוא רשת הביטחון, כדי
// שבנייה איטית תסתיים ולא תיחתך באמצע.
